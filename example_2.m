...
% S.bone_mode = 'realistic'; %defualt is simulation bone - need to specify realistic if wanted
...
% sources_brain = sources_brain;

% Save to .mat
cd('D:\OPM\sub-OP00210\fwd\');
save('geometries_sim_bone.mat', 'mesh_wm', 'mesh_bone', 'mesh_heart',...
    'mesh_lungs', 'mesh_torso','coils_3axis','sources_cent');
% save('geometries_realistic_bone.mat', 'mesh_wm', 'mesh_bone', 'mesh_heart',...
%     'mesh_lungs', 'mesh_torso','mesh_brain', 'mesh_iskull', 'mesh_oskull', 'coils_3axis','sources_cent', 'sources_brain');
